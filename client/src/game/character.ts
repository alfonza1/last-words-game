...
function drawHair(ctx: CanvasRenderingContext2D, style: string, color: string, scale: number) {
  ...
  if (style === 'mohawk') {
    ...
    ctx.quadraticCurveTo(7 * scale, -18 * scale, 7 * scale, -6 * scale);
    ctx.moveTo(18 * scale, -30 * scale);
    ctx.quadraticCurveTo(14 * scale, -17 * scale, 13 * scale, -3 * scale);
    ctx.moveTo(29 * scale, -30 * scale);
    ctx.quadraticCurveTo(34 * scale, -17 * scale, 33 * scale, -3 * scale);
    ctx.moveTo(33 * scale, -29 * scale);
    ctx.quadraticCurveTo(40 * scale, -18 * scale, 40 * scale, -6 * scale);
    ctx.stroke();
